        ...
        const fetchDashboardData = async () => {
            try {
                ...
                if (announceRes.data?.success)
                    setAnnouncements(announceRes.data.data.slice(0, 3));
            } catch (error) {
        ...
        <Layout role="admin">
            <div className="mb-7">
                ...
                <p className="text-sm text-gray-500 mt-1">
                    Monitor platform operations, users, and system-wide
                    activities.
                </p>
            </div>
                    ...
                    <Card>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            <Link to="/admin/courses">
                                <Button
                                    variant="outline"
                                    className="h-auto w-full py-4 flex flex-col items-center gap-2"
                                >
